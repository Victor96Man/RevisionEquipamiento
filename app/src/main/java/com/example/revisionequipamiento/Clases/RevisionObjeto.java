...
public class RevisionObjeto {
   ...
   /* @Override
    ...
    @Override
    public String toString() {
        String json ="{'revision':{'id':'"+id+"', 'equipamiento':'"+equipamiento+"', 'usuario':"+usuario+", 'fR':'"+fR+"', 'estado':"+estado+", 'enviado':"+enviado+", 'vp1':"+vp1+", 'vp2':"+vp2+", 'vp3':"+vp3+", 'vp4':"+vp4+", 'vp5':"+vp5+", 'vp6':"+vp6+", 'vp7':"+vp7+", 'vp8':"+vp8+", 'vp9':"+vp9+", 'vp10':"+vp10+", 'obp1':'"+obp1+"', 'obp2':'"+obp2+"', 'obp3':'"+obp3+"', 'obp4':'"+obp4+"', 'obp5':'"+obp5+"', 'obp6':'"+obp6+"', 'obp7':'"+obp7+"', 'obp8':'"+obp8+"', 'obp9':'"+obp9+"', 'obp10':'"+obp10+"', 'firma':'"+firma.replaceAll("\n", "")+"', 'firmaT':'"+firmaT.replaceAll("\n","")+"', 'objeciones':'"+objecione+"', 'peticiones':'"+peticiones+"','fotos':[";
        if(fotos.size() >0) {
